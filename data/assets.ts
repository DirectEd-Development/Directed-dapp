export const data = [
	{
		id: 1,
		name: 'Eqoso Muri',
		image: '/static/images/Directed Heros/Ngong-Heros/Eqoso-Muri.png',
		caption: 'Muruthi was his name',
		description:
			'From his childhood, he suffered untold misery. Growing up an orphan and being thrown away by the pack, gave him the  the urge to prove himself to the others that he was strong and not a weakling. He became fearless and merciless . He had an ardent ambition to always take the extra step which no one else in their right mind was willing to. He was not only physically fit and fearless but also had no weakness as his heart clouded his judgment. His ardent ambition to seek recognition made him put everything behind him for the sake of the community. His ruthless and merciless character never withstanding atrocities committed against him and his kinsmen made him the most revered heroes of the community. His past of abandonment was always brought up making him feel inferior, frail and vulnerable. However strong he was, mentally he was frail. He took this as an opportunity to become better and accomplish more. His eyes glowed with passion and desire to not only be the most feared but the best and devoted warrior to ever walk on earth. His sheer determination made him a sole sojourner who always carried his community on his back not caring about anyone’s wishes',
	},
	{
		id: 2,
		name: 'Mareo Razsam',
		image: '/static/images/Directed Heros/Mangu-Heros/Mareo-Razsam.png',
		caption: 'The Wits of Mareo Razsam',
		description:
			'Mareo NgamaThere once lived a fearsome cat called Paka power. His fur was darker than the darkest night known to all. His eyes were always bloodshot and his boiling anger was thought to overflow from his sharp ears. The cat was known to slaughter herds of buffalos using his lightning speed and overwhelming strength. He bullied elephants and rhinos who were helpless against him. He filled graveyards at will with the lives of innocent hyenas till they were no more. At the prime of his tyrannical reign arose ambition in a young lion, Mareo Ngama, the Lion Kingdom heir. Saddened by the blood and tears shed by his loyal subjects, he challenged Paka Power to a duel by the watering hole under the full moon in the presence of all animals. Armed with nothing but his wits and lion strength, he was ready. At last! The fight began. Paka power terrorized Ngwenyama with his powerful punches and merciless kicks. Ngwenyama was no match with powerful Paka Power, and was left lying on the ground crying unto his dead ancestors for help . Paka power took this mighty moment to blow his own trumpet saying how he commanded all oceans. When Paka power turned his back, Mareo Ngama had the perfect counter attack. He slashed open Paka powers belly and pulled out his intestines. He pulled out his throat using his long canines, Paka’s body lay lifeless on the ground as the crowd shouted in celebration. Mareo Ngama let out an awesome roar to seal his position as the new king of the jungle. Long live the king!',
	},
	{
		id: 3,
		name: 'Sahara Mathi',
		image: '/static/images/Directed Heros/Kagumo-Heros/Sahara-Mathi.png',
		caption: 'The Hero of Yoxa',
		description:
			'Sahara was an outcast in the Yoxa kingdom, despite being one of the finest warriors in the Yoxan army. Many years back, he refused to attack innocents lions during one of the many wars fought by the Yoxan army and deserted the army. He had earned great respect from his fellow soldiers that his superiors could neither execute him nor jail him in fear of those loyal to Sahara. Instead, they chose to make him an outcast, first expelling him from the cities and then slowly spreading lies about him. At the time, the Yoxa kingdom was ruled by an despotic leader, King Yander, who ruled the kingdom as a dictator. His rule was highly detested by the lions of the kingdom. There was need for a hero who would take it upon himself and save the kingdom. Lions from all around the kingdom complained for a long time about Yander but could do nothing since he was strong and fierce. Some heroic lions tried to fight Yander and save the kingdom but were mercilessly torn apart. Cries of Yoxa lions were finally heard. After years of living as an outcast, Sahara had honed his skills and mastered the art of war. Hearing the people’s cries for help, Sahara decided to challenge Yander and free the people of Yoxa from the tyranny of Yander. Sahara returned and challenged Yander in front of all the lions of Yoxa leaving Yander with no choice but to accept. On the day of the challenge, Yander immensely bragged about how strong he was and how he would defeat and kill Sahara for challenging him. However, Sahara had trained for years and despite the many advantages Yander had given himself in the form of magic and weaponry, the battle was quickly over. Sahara broke Yander’s bones and killed the tyrant mercilessly. All the lions of Yoxa were amazed by the strength of Sahara and from that day onwards, Sahara was hailed as the great hero that had freed Yoxa from a tyrant. Many wanted Sahara to take the throne, but this was not what Sahara wanted. For years to come, he remained the guardian of Yoxa, ready to defend whenever enemies challenged them.',
	},
	{
		id: 4,
		name: 'Saritavak Chrupst',
		image: '/static/images/Directed Heros/Mangu-Heros/Saritavak-Chrupst.png',
		caption: 'The Dreaded Saritavak KudaLo',
		description:
			"In the ancient lands of Kudalo, a dreaded creature whose reign would be etched in very many communities lived. The creature, Sarivatak, was so scary that many believed it could appear in their dreams and turn them into nightmares. Sarivatak had a  well-built muscular body. He led a pride of lions consisting of nine other lions who always had his back. Sarivatak had for years oppressed frail and elderly lions enforcing his tyrannical rule with the help of other lions. Albeit there were few lions who wanted to resist, there was really nothing they could do. However, one day, one of the lions in Sarivatak's pride, Kavirota felt pity for she witnessed how many succumbed to Sarivatak`s despotic rule and his infamous guillotine. She liaised with some of the rebel lion in order to help save them. They hatched a well-laid out plan which although very risky, would help remove them from sarivatak's rule and power which he had gripped so tenaciously. On the night they had planned the coup, they cautiously approached Sarivatak's tent after he had gone into deep slumber. The tent was usually guarded by lions armed to the teeth but on this night the elderly lions were not so hapless. As they tiptoed towards his bed they were each gripped by so much fear, the air was tangible. As the rebel lions carefully approached Sarivatak's bed Kavirota mistakenly dropped her dagger. This woke up Sarivatak who immediately seized one of the rebel lions and pounced his body with his sharp claws. Kavirota quickly turned back and slit his throat killing him! His death meant the end of the oppression which elderly and weak lions who did not surpot his rule , suffered.",
	},
	{
		id: 5,
		name: 'Ligaro Yanyali',
	...
	},
	{
		id: 8,
		name: 'Theolas Rokele',
		image: '/static/images/Directed Heros/Maryhill-Heros/Theolas-Rokele.png',
		caption: 'The Legend of Theolas Rokele',
		description:
...

	{
		...
		caption: 'The Legend of the Mighty Shishu Darlido',
		description:
			"Shishu was a fearless lion that had double crossed Jango, a very vicious pride of lions that had caused a reign of terror in the Yoxa kingdom for many decades . The Jango were very known for resulting to violence and war every single time they didnt get what they wanted, they were in pursuit of Shishu for double crossing them and stealing there armours. Shishu had  had enough of the prides reign of terror and decided to forge a strong relationship with the pride inorder to build his trust amongst the members of the Jango pride. Shishu became close to the pride and was almost one of them . After building the trust, Shishu decided one day to invite the pride to a feast at his territory as he claimed. At the feast he gave the Jango too much beer that they drunk and got inebriated and blacked out . In the middle of the night  Shishu stole their invincible armours that were believed to be inpiercible that even the sharpest spears,arrows or canines couldn't penetrate . It was believed that these armours were the reason for their strength and victory for long, since the pride never lost a single war and they took over any territory or possessions they wanted with ease. Shishu knowing it was the the best opportunity to snatch their armours he never hesitated to grab those possessions and hid them where only he could find them. Later the next day, the Jango pride came to after they were suddenly waked up by a rumbling of the earth, which was caused by rhinos. The Rhinos had been sent by Shishu and they were charging up against the now vulnerable pride of Jangos. The Jangos took to their heels trying to escape the pursuit of the Rhinos. Finally,  the Jango pride was kicked out of the kingdom and no word was heard from them again. Shishu Darlido was appreciated by the whole of the Kingdom and was crowned to rule it. Shishu earned himself great popularity and grew to fame except only to the Jango pride which soon vowed to return and avenge their fate.",
	},
	{
		id: 10,
		name: 'Moja Nadka',
		image: '/static/images/Directed Heros/Ngong-Heros/Moja-Nadka.png',
		caption: 'The Story of Moja Nadka',
		description:
			'This is the story of Moja from Tigeritis. He was born of a lion mother and had a tiger for a father. Being a half breed, his father noticed his difference and decided to kick him out. He wandered through the plains, surviving off scraps, which he shared with vultures; he was able to survive until he became an adolescent. Through these hardships mojang developed a resentment towards his pride father who kicked him out for being different. In wonders, he was fortunate to be being different assimilated into a tribe of rival lions due to his extraordinary strength, speed, agility and intelligence which surprised the average lion. It did not take long until he was a fully-fledged member to the extent of being the prides leader right hand lion. Due to his status he was able to overhear plans to overthrow his pride fathers pride. His resolve was tested and he was torn between what he had built up or his family who had turned theirs back to him. He battled with himself till he realized that was blood was thicker than water. He decided to fight for his family, whatever it have cost him. He approached the pride leader and tried to convince him to change his mind but he refused and called him traitor. They had a fierce battle to decide who the leader of the pride where Moja won. Moja called off the attack and declined to make amends with his father. He was finally accepted as a leader by both prides.',
	},
	{
		id: 11,
		name: 'Zimba Kalrak',
		image: '/static/images/Directed Heros/Kagumo-Heros/Zimba-Kalrak.png',
		caption: 'The lore of Kajhel Zimba',
		description:
			'This is the lore of Kajhel Zimba - protector of the people. This is due to its pivotal and heroic actions in saving hundreds of Noli people from the suffering imposed on them by the white Telujis during the second era. Kajhel Zimba has its origin in the famous Tsavo region. Kajhel was a nomad, traversing across the plains of Noli. Eventually she arrived in a village near the famous Timbuktu forest. Kajhel Zimba was always frequently alarmed and witnessed Nolians in the village being harassed by invaders from a foreign kingdom, the white Teluji. During one night, as the Epkal troops trodden down the villages manoeuvring to get labourers, Kajhel was spotted. Three Epkal warriors caught a glimpse of Kajhel and immediately lunged to kill her. They chased its silhouette into the black forest, burning with fury to kill Zimba. Kajhel fortunately evaded the irksome chase by slipping into a strange cave. As it was resting after a tiresome day, Kajhel saw a glow from a crack of the cave with curiosity, Kajhel approached the glow but upon touching it, she was thrown back with a vindictive force. Kajhel passed out and came in later early in the morning. Zimba noticed an abnormal restructure in its body and could not place the course. Zimba felt thrice stronger eyes glowing and would reach a target point at a supersonic speed. On one sunny afternoon as Zimba was trailing past the bulbous and gigantic forest trees it came across a troupe of other lions gracing a walk in the forest. Kajhel was a stranger and a foreigner to the troops and as a result, she was repelled. With an agility of a cobra, Kajhel pounced on one approaching masculine giant lion which was ultimately the leader of the troop with a heavy punch the leader lion fell flat breathing in nerve-jerking pain, with all this Kajhel became feared. Kajhel organized a trooper with ten lions and went to manoeuvre into life-saving mission. Kajhel attacked the white Teluji troops and tore them into pieces; the other nine members also gained momentum and did the same. Many missions of the whites in the trek of Noli colonization were destroyed leaving the layout of Europeans futile. Many Europeans feared the villagers surrounding the forest and the villages surrounding the forest. With terrible speed, it would escape bullets and kill the killers themselves. Through her efforts, Nolians in the Teluji area gained morale for fighting for their independence. Unfortunately, powerful Kajhel out of trusting her own trope members got tricked and was led into an ambush by one of her own. She was killed and villagers took the body, performed some rituals and preserved the body. It is believed that through Kajhel they got new strength and zeal to venture into daily activities.',
	},
	{
		id: 12,
		name: 'Tanya Naigu',
	...
	},
	{
		id: 13,
		name: 'Ciara Yobezi',
		image: '/static/images/Directed Heros/Ngong-Heros/Ciara-Yobezi.png',
	...
	},
	{
		...
		caption: 'The Legend of Nemea Kori',
		description:
	...
	},
	{
		id: 16,
		name: 'Kasandra Ribur',
		image: '/static/images/Directed Heros/Mangu-Heros/Kasandra-Ribur.png',
