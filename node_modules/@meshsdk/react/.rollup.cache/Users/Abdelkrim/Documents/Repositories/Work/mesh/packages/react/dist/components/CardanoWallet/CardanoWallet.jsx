...
export const CardanoWallet = ({ label = 'Connect Wallet', onConnected = undefined }) => {
    ...
    return (<div style={{ width: 'fit-content' }} onMouseEnter={() => setHideMenuList(false)} onMouseLeave={() => setHideMenuList(true)}>
      <StyledMenuButton type="button" className="mr-wallet-button" onClick={() => setHideMenuList(!hideMenuList)}>
        <WalletBalance name={name} connected={connected} connecting={connecting} label={label}/>
      </StyledMenuButton>
      <StyledMenuList hidden={hideMenuList} className="mr-menu-list">
