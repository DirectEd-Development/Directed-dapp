												...
												>
													<div className='card-body'>
														...
														<h3 className='text-lg'>
															All donors receive a token which unlocks access to
															the Scholars Progress and Donor's Portal page!
														</h3>
													</div>
												</div>
											</div>
											...
											<div className='dropdown dropdown-hover'>
												...
												>
													<div className='card-body'>
														...
														/>
														<h3 className='text-lg'>
															All donors receive digital art pieces from four
															tiers, each with different utilities and unique
															names.
														</h3>
													</div>
												</div>
											...
											<div className='dropdown dropdown-hover'>
												...
												>
													<div className='card-body'>
														...
														/>
														<h3 className='text-lg'>
															Hero, Royal and God tier donors are invited to an
															exclusive DirectEd Donor's Dinner taking place
															once a year at the University of Oxford.
														</h3>
													</div>
												</div>
											</div>
								...
								<div className='flex justify-center items-center mt-2'>
									<div className='box-border border border-[#999999] bg-white w-4/5 h-fit rounded-lg shadow'>
										<div className='flex mb-2'>
											<div className='flex-auto w-2/6 h-full my-7'>
												<Image
													className='px-0 ml-5 '
											...
											<div className='flex-auto w-1/6'>
												<div className='dropdown dropdown-hover mt-4'>
													...
													>
														<div className='card-body'>
															<Image
																className='mt-4 cursor-pointer inline'
																src='/static/images/Hover.png'
																alt='image'
																width='30'
																height='30'
															...
															<h3 className='text-sm'>
																Scholarship naming rights can be purchased.
																However, to protect the reputation and integrity
																of the scholarship, we reserve the right to
																reject and return donations from donors we deem,
																in our sole discretion, to be inappropriate to
																accept funds from. You can read the full terms
																<Link
