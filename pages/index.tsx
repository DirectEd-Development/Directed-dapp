                        ...
                        <div className="box-border border border-[#999999] bg-white w-4/5 h-fit rounded-lg shadow">
                            <div className="flex mb-2">
                                ...
                                <div className="flex-auto w-3/6 h-full">
                                    <p className="text-center font-semibold mt-3 mb-3 text-lg">Naming Rights</p>

                                    <p className="text-[13px] text-center">
                                        The donor naming rights for a given scholarship cohort can be purchased for $3,000
                                    </p>
                                </div>
                                <div className="flex-auto w-1/6">
                                    <div className="dropdown dropdown-hover mt-4">
                                        ...
                                        <div
                                            ...
                                            >
                                            <div className="card-body">
                                                <Image className="mt-4 cursor-pointer inline" src="/static/images/Hover.png" alt="image" width="30" height="30"/>
