      ...
      <main className="container grid grid-cols-1 gap-10 py-8  justify-items-center">
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
            <div className="px-6 py-4 justify-items-center">
                ...
                Once upon a time, there lived a lioness, Ciara from the Akandawa Kingdom. She had soft golden fur that glittered in the sunset and shiny golden eyes. Her marvelous geit was enough to portray how powerful she was. Everyone from Akandawa recalls the story of Ciara, and how she rose to be the most powerful and fierce lioness in the land, a story that has been passed from one generation to the next. <br /><br />
                Ciara had been just but a normal lioness in the grasslands until one day when the Majitu clan of hyenas, led by Janja, attacked the Akandawa Kingdom. A severe famine had struck not only in the Akandawa Kingdom but all neighboring kingdoms, including that of Majitu. The Akandawa had luckily foreseen the devastating famine and stored a lot of food that would sustain them during the drought. The gluttonous Majitu saw this and was green with envy. They therefore posed frequent attacks on the Akandawa. <br /> <br />
